...
def insertData():
    ...
    insertLabel = Label(insertWindow, text="Which table to enter data into?", anchor=CENTER,
                        font=("helvetica", 25, "bold"))
    insertButton1 = Button(insertWindow, text="CLUBS", width=20, height=2, command=insertClub, bg="white", fg="BLACK",
                           font=("bold"))
    insertButton2 = Button(insertWindow, text="AGENTS", width=20, height=2, command=insertAgent, bg="white", fg="BLACK",
                           font=("bold"))
    insertButton3 = Button(insertWindow, text="NATIONAL TEAM", width=20, height=2, command=insertNational, bg="white",
                           fg="BLACK", font=("bold"))
    insertButton4 = Button(insertWindow, text="PLAYERS", width=20, height=2, command=insertPlayer, bg="white",
                           fg="BLACK", font=("bold"))
    insertExit = Button(insertWindow, text="BACK", width=20, height=2, command=insertWindow.destroy, bg="black",
                        fg="red", font=("bold"))
...
def viewalldata():
    ...
    def viewPlayer():
        ...
        def namePlayer():
            def searchName4():
                cursor.execute('select * from  Players  where first_name  like ? OR last_name like ?',
                               (nEntry.get() + '%', nEntry.get() + '%'))
                data = cursor.fetchall()
                displayPlayer(data)
            ...
            nEntry.grid(row=2, column=2, pady=20)
            print(nEntry.get())
            nameSearch = Button(name, text="SEARCH", width=20, height=2, command=searchName4, bg="white", fg="BLACK",
                                font=("bold"))
            nameSearch.grid(row=5, column=0, pady=30)
        ...
        def clubPlayer():
            ...
            nEntry.grid(row=2, column=2, pady=20)
            print(nEntry.get())
            nameSearch = Button(name, text="SEARCH", width=20, height=2, command=searchPclub, bg="white", fg="BLACK",
                                font=("bold"))
            nameSearch.grid(row=5, column=0, pady=30)
        ...
        def ratingPlayer():
            def searchRating():
                cursor.execute('select * from  Players  where RATING BETWEEN ? AND ?  AND POSITION LIKE ?',
                               (nEntry1.get(), nEntry2.get(), nEntry3.get()))
                data = cursor.fetchall()
                displayPlayer(data)
        ...
        def nationPlayer():
            ...
            nameSearch = Button(name, text="SEARCH", width=20, height=2, command=searchNation, bg="white", fg="BLACK",
                                font=("bold"))
            nameSearch.grid(row=5, column=0, pady=30)
        ...
        def agentPlayer():
            ...
            nameSearch = Button(name, text="SEARCH", width=20, height=2, command=searchAgent, bg="white", fg="BLACK",
                                font=("bold"))
            nameSearch.grid(row=5, column=0, pady=30)
        ...
        PlayerButton3 = Button(Player, text="Club", width=20, height=2, command=clubPlayer, bg="white", fg="BLACK",
                               font=("bold")).pack(anchor=CENTER, pady=15)
        PlayerButton4 = Button(Player, text="Nation", width=20, height=2, command=nationPlayer, bg="white", fg="BLACK",
                               font=("bold")).pack(anchor=CENTER, pady=15)
        PlayerButton4 = Button(Player, text="Agent", width=20, height=2, command=agentPlayer, bg="white", fg="BLACK",
                               font=("bold")).pack(anchor=CENTER, pady=15)
        PlayerButton6 = Button(Player, text="Rating & Position", width=20, height=2, command=ratingPlayer, bg="white",
                               fg="BLACK", font=("bold")).pack(anchor=CENTER, pady=15)
    ...
    def viewAgent():
        def ratingAgent():
            ...
            nEntryy = Entry(name, bd=5)
            nEntryy.grid(row=3, column=2, pady=20)
            nameSearch = Button(name, text="SEARCH", width=20, height=2, command=searchArating, bg="white", fg="BLACK",
                                font=("bold"))
            nameSearch.grid(row=5, column=0, pady=30)
            nameExit = Button(name, text="BACK", width=20, height=2, command=name.destroy, fg="red", bg="black",
                              font=("bold"))
        ...
        def naAgent():
            ...
            nEntry.grid(row=2, column=2, pady=20)
            print(nEntry.get())
            nameSearch = Button(name, text="SEARCH", width=20, height=2, command=searchNname, bg="white", fg="BLACK",
                                font=("bold"))
            nameSearch.grid(row=5, column=0, pady=30)
        ...
        def nameAgent():
            ...
            nEntry.grid(row=2, column=2, pady=20)
            print(nEntry.get())
            nameSearch = Button(name, text="SEARCH", width=20, height=2, command=searchAname, bg="white", fg="BLACK",
                                font=("bold"))
            nameSearch.grid(row=5, column=0, pady=30)
        ...
        AgentButton1 = Button(Agent, text="ALL", width=20, height=2, command=allAgent, bg="white", fg="BLACK",
                              font=("bold")).pack(anchor=CENTER, pady=25)
        AgentButton2 = Button(Agent, text="Agent Name", width=20, height=2, command=nameAgent, bg="white", fg="BLACK",
                              font=("bold")).pack(anchor=CENTER, pady=25)
        AgentButton3 = Button(Agent, text="Nationality", width=20, height=2, command=naAgent, bg="white", fg="BLACK",
                              font=("bold")).pack(anchor=CENTER, pady=25)
    ...
    viewButton2 = Button(viewWindow, text="AGENTS", width=20, height=2, command=viewAgent, bg="white", fg="BLACK",
                         font=("bold"))
    viewButton3 = Button(viewWindow, text="NATIONAL TEAM", width=20, height=2, bg="white", fg="BLACK", font=("bold"),
                         command=viewNation)
